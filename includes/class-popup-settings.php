...
class Popup_Settings {
    ...
    public function add_menu_item() {
        $page = add_menu_page(__('Plugin Settings', 'popup'), __('PopUp Settings', 'popup'), 'manage_options', $this->parent->_token . '_settings', array($this, 'settings_page'));
    ...
    public function settings_page() {
        ...
        $html .= '<input name="Submit" type="submit" class="button-primary" value="' . esc_attr(__('Uloz', 'wordpress-plugin-template')) . '" />' . "\n";
        $html .= '</p>' . "\n";
        $html .= '</form>' . "\n";
        $html .= '</div>' . "\n";
